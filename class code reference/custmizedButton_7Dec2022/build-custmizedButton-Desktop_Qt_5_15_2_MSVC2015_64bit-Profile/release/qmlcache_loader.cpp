...
namespace _0x5f__TextButton_qml { 
    extern const unsigned char qmlData[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), nullptr, nullptr
    };
}
namespace _0x5f__TextIcon_qml { 
    extern const unsigned char qmlData[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), nullptr, nullptr
    };
}
namespace _0x5f__ButtonBase_qml { 
    extern const unsigned char qmlData[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), nullptr, nullptr
    };
...
Registry::Registry() {
        ...
        resourcePathToCachedUnit.insert(QStringLiteral("/TextButton.qml"), &QmlCacheGeneratedCode::_0x5f__TextButton_qml::unit);
        resourcePathToCachedUnit.insert(QStringLiteral("/TextIcon.qml"), &QmlCacheGeneratedCode::_0x5f__TextIcon_qml::unit);
        resourcePathToCachedUnit.insert(QStringLiteral("/ButtonBase.qml"), &QmlCacheGeneratedCode::_0x5f__ButtonBase_qml::unit);
