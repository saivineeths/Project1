...
class Button_Class : public QObject
{
    ...
    Q_PROPERTY(bool text_image_Buttom_handler READ text_image_Buttom_handler WRITE setText_image_Buttom_handler NOTIFY text_image_Buttom_handlerChanged)
public:
    ...
    void setText_image_Buttom_handler(bool newText_image_Buttom_handler);
