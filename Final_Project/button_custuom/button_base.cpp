...
{
setBase_Button_enabler(!base_Button_enabler());                     //toggling the base_button enable

}

void button_base::text_Button_Change()
{
    setText_Button_enabler(!text_Button_enabler());                 //toggling the text_Button_enable
}

void button_base::icon_Button_Change()
{
    setIocn_Button_enabler(!iocn_Button_enabler());                 //toggling the icon_Button_enable
}

void button_base::icon_Text_Button_Change()
{

    setText_Icon_Button_enabler(!text_Icon_Button_enabler());       //toggling the text_icon_Button_enable
}
